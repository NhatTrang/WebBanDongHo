...
<div class="header">
                ...
                <div class="header_navbar">
                    <ul class="header_navbar-ul">
                        ...
                        <li class="header_navbar-li header__navbar-item--saparate">
                         ...
                         <li class="header_navbar-li header__navbar-item--saparate">
                            <a href="donhangdaxacnhan" class="header_navbar-link header_magin color">ĐƠN HÀNG ĐÃ XÁC NHẬN</a>
                         </li>
                    </ul>
                    <ul class="header_navbar-ul">
                        <li class="header_navbar-li ">
        ...
        <div class="container">
        	<div class="grip">
        		<h1 class="container_loai-h1">THÔNG TIN ĐƠN HÀNG ĐÃ XÁC NHẬN</h1>
	        	<table class="table table-hover">
	        		<thead > 
		        		<tr class="container_loai-header">
			        		...
			        		<th class="container_loai-span">TÌNH TRẠNG</th>
		        		</tr>
	        		</thead>
	        		<tbody class="container_loai-body">
	        				<c:forEach var="l" items="${dshdxn}">
	        					<tr>
	        						<td>${l.getMaHoaDon()}</td>
	        						<td>${l.getMaKH()}</td>
	        						<td>${l.getNgayMua()}</td>
	        						<td>${l.getDaMua()}</td>
	        						<td class="container_loai-body-a">ĐÃ XÁC NHẬN<td>
	        					</tr>
	        				</c:forEach>
	        		</tbody>
	        	</table>

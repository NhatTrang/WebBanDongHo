	        	...
	        	<table class="table table-hover">
	        		<thead > 
		        		<tr class="container_loai-header">
		        			<th class="container_loai-span">MÃ CHI TIẾT</th>
			        		...
			        		<th class="container_loai-span">THÀNH TIỀN</th>
			        		<th class="container_loai-span">ĐÃ MUA</th>
		        		</tr>
	        		</thead>
	        		<tbody class="container_loai-body">
	        				<c:forEach var="l" items="${dsxn}">
	        					<tr>
	        						<td>${l.getMaChiTietHD()}</td>
	        						<td>${l.getMaHoaDon()}</td>
	        						<td>${l.getMaKH()}</td>
	        						...
	        						<td>${l.isDaMua()}</td>
	        						<td>
	        							<c:if test="${l.isDaMua() == false}">
											<a href="chitiethoadoncontroller?mcthd=${l.getMaChiTietHD()}&&mhd=${l.getMaHoaDon()}" class="container_loai-body-a">
